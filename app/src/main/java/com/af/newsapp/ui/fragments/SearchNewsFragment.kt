...
import com.af.newsapp.util.Constants
import com.af.newsapp.util.Constants.Companion.QUERY_PAGE_SIZE
            ...
            when (response) {
                is Resource.Success -> {
                    ...
                    response.data?.let { newsResponse ->
                        //handle pagination
                        searchNewsAdapter.differ.submitList(newsResponse.articles.toMutableList())
